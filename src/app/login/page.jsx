            ...
            <div className='flex justify-center items-center'>
                <div className='w-[400px] shadow-xl p-10 mt-5 rounded-xl'>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button className='bg-green-500 text-white border py-2 px-2 rounded text-lg my-2' type='submit'>Sign In</button>
                        <hr className='my-3' />
                        <p>Do not have an account? Go to <Link href="/register" className='text-blue-500 hover:underline'>Register</Link> Page 
                        </p>
                    </form>
                </div>
            </div>
