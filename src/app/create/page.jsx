  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      if(res.ok){
        ...
        throw new Error("Faied to create a post");
      }
        ...
        <div className="flex-grow">
            <div className="container mx-auto shadow-xl my-10 p-10 rounded-xl ">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <textarea onChange={(e) => setContent(e.target.value)} name="" id="" cols="30"  rows="10" placeholder='Enter your post contentz' className="w-[300px] block bg-gray-200 border py-2 px-3 rounded text-lg my-2"></textarea>
                    <button className='bg-green-500 text-white border py-2 px-2 rounded text-lg my-2' type='submit' name="create">Create post</button>
                </form>
            </div>
        </div>
      <Footer/>
