...
function AdminUserManagePage() {
    ...
    console.log("getAllUsersData",allUsersData)
            ...
            <div className="flex-grow">
                <div className="container mx-auto">
                    <div className="flex mt-10">
                        <SideNav/>
                        <div className="p-10">
                            <h3 className="text-3xl mb-3 flex"> <FaAddressCard className='mr-2'/> Manage Users</h3>
                            <p>A list of users retrieved from a MongoDB database</p>

                            <div className='shadow-lg overlow-x-auto'>
